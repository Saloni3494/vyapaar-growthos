"""
Vyapaar GrowthOS Smart Inventory Inference Agent
...
INVENTORY_RECOMMENDATION_PROMPT = """You are Vyapaar GrowthOS's inventory advisor for Indian small businesses.

...
const FEATURES: Feature[] = [
  {
    ...
    subtitle: "Speak naturally in Hindi or English. Vyapaar GrowthOS listens, understands, and records.",
    points: [
    ...
    screenshotAlt: "Vyapaar GrowthOS Dashboard with P&L and morning briefing",
  },
  {
    id: "udhari",
    icon: BookOpen,
  ...
  },
  {
    ...
    screenshotAlt: "Vyapaar GrowthOS AI Chat with Muneem in Hindi",
  },
  {
    id: "schemes",
    icon: Landmark,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              ...
              Vyapaar GrowthOS is the bridge.
            </p>
          </AnimatedSection>
            ...
            <div className="relative rounded-3xl bg-gradient-to-br from-[#002E6E] to-[#00BAF2] p-12 md:p-20 overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-lg text-white/70 mb-8 max-w-xl mx-auto">
                  Join thousands of Indian shopkeepers who are already using Vyapaar GrowthOS
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-xs text-gray-400">
              &copy; 2026 Vyapaar GrowthOS. Made with love in India.
            </p>
          </div>
        </div>
      </footer>

...
export default function CustomersPage() {
  ...
  const handleWinback = async (id: string) => {
    try {
      await fetch(`${API_BASE_URL}/api/customers/${DEMO_MERCHANT_ID}/winback/${id}`, { 
        method: "POST",
  ...
  return (
    <div className="space-y-5 w-full">
      ...
      {/* RFM Segments + Top Customers stacked */}
      <div className="flex flex-col gap-5">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            isWinbackSent
                              ...
                              : "bg-vyapaar-primary text-white active:bg-vyapaar-primary/90"
                          )}
                        >

...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-dvh">
      {/* Left Panel — Branding */}
      <div className="relative hidden overflow-hidden border-r border-slate-200/80 bg-[#f3faff] lg:flex lg:w-[60%]">
        {/* Soft workspace backdrop */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(0,186,242,0.22),transparent_24rem),linear-gradient(135deg,#f7fcff_0%,#eaf7ff_100%)]" />

        {/* Decorative circles */}
        <div className="absolute -left-32 -top-32 h-96 w-96 rounded-full border border-[#00baf2]/10" />
        <div className="absolute right-0 top-1/4 h-64 w-64 translate-x-1/2 rounded-full border border-[#0066cc]/10" />
        <div className="absolute bottom-0 left-1/4 h-80 w-80 rounded-full border border-[#00baf2]/15" />
        <div className="absolute bottom-10 right-10 h-48 w-48 rounded-full border border-[#0066cc]/10" />
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(0,46,110,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(0,46,110,0.06) 1px, transparent 1px)",
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-lg">
            ...
            >
              <h2
                className="mb-4 text-5xl font-bold leading-tight text-[#002e6e] xl:text-6xl"
                lang="hi"
              >
                आपका डिजिटल
                <br />
                <span className="text-[#007bb0]">
                  मुनीम
                </span>
              </h2>
            ...
            <div className="mt-12 space-y-5">
              {FEATURES.map((f, i) => (
                ...
                >
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-[#00baf2]/15 bg-white/80 shadow-sm transition-colors group-hover:bg-white">
                    <f.icon className="h-5 w-5 text-[#0066cc]" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-[#002e6e]">
                      {f.title}
                    </p>
      ...
      <div className="relative flex flex-1 items-center justify-center bg-white p-6 sm:p-8 lg:w-[40%]">
        {/* Home button */}
        <Link
          href="/"
          className="absolute right-6 top-6 z-10 flex items-center gap-1.5 rounded-lg bg-slate-50 px-3 py-1.5 text-xs font-medium text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700"
        >

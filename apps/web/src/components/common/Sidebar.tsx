...
export function Sidebar({ payScore = 74 }: SidebarProps) {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      {/* Brand */}
      <div className={cn(
        "flex items-center gap-3 border-b border-slate-200/70 px-5 py-5",
        ...
        {!collapsed && (
          <div className="flex flex-col">
            <span className="text-[15px] font-bold tracking-tight text-[#002e6e]">
              Paytm Vyapaar
            </span>
            <div className="flex items-center gap-1.5">
              <span className="text-[11px] font-medium text-slate-400">GrowthOS workspace</span>
              {isConnected && <LiveDot />}
            </div>
          </div>
        )}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "bg-[#e6f7fd] text-[#002e6e] shadow-sm"
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-slate-50/70 p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-bold text-slate-900">PayScore</p>
                <p className="text-[11px] text-slate-400">Credit health</p>
              </div>
            </div>
            <div className="mt-3 pt-3 border-t border-gray-100 flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="truncate text-xs font-semibold text-slate-900">Sunita Saree Shop</p>
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 border-r border-slate-200/70 bg-white/90 shadow-[4px_0_24px_-12px_rgba(0,46,110,0.12)] backdrop-blur-xl transition-all duration-300",

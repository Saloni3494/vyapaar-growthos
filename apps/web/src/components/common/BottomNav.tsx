              ...
              >
                <div
                  className={cn(
                    ...
                    isActive
                      ? "bg-vyapaar-primary scale-110 shadow-vyapaar-primary/40"
                      : "bg-vyapaar-primary/90 hover:bg-vyapaar-primary"
                  )}
                >
                ...
                <span
                  className={cn(
                    ...
                    isActive
                      ? "text-vyapaar-primary"
                      : "text-vyapaar-text-secondary"
                  )}
                >
                  {item.hindiLabel}
                </span>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "text-vyapaar-primary"
                  : "text-vyapaar-text-secondary hover:text-vyapaar-text-primary"
              )}
            >
              <Icon
                className={cn(
                  "h-5 w-5 transition-colors",
                  isActive ? "text-vyapaar-primary" : "text-vyapaar-text-secondary"
                )}
              />
              <span className="text-[10px] font-medium">{item.hindiLabel}</span>
              {isActive && (
                <span className="absolute -top-px left-1/2 h-0.5 w-8 -translate-x-1/2 rounded-full bg-vyapaar-primary" />
              )}
            </button>
          );
        })}

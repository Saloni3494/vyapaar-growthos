...
function PayScoreBadge({ score }: { score: number }) {
  ...
  return (
    ...
    >
      ...
      <span className="absolute text-[9px] font-bold text-vyapaar-text-primary">
        {score}
      </span>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-vyapaar-primary-dark">
      ...
      {/* Center: Shop Name */}
      <h1 className="absolute left-1/2 -translate-x-1/2 text-sm font-semibold text-vyapaar-text-primary truncate max-w-[40%]">
        {shopName}
      </h1>

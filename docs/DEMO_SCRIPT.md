# Vyapaar GrowthOS Demo Script — Fin-O-Hack Grand Finale

## Setup (Before Demo Starts)

1. Open Dashboard: `https://vyapaar-growthos.vercel.app` on the projector
...
> But Vyapaar GrowthOS has already sent her this morning briefing on WhatsApp."
...
**Narrate:**
> "This is where Vyapaar GrowthOS becomes AGENTIC.
...
**Vyapaar GrowthOS responds (TTS in Hindi):**
...
> Every Vyapaar GrowthOS action = Paytm revenue.
>
...
> Vyapaar GrowthOS gives them a way to UNDERSTAND, PROTECT, and GROW that money.
>
